...
**fcc_cat_dog_70.ipynb:** About 70% Accuracy

**Cat and Dog with pretrained model.ipynb:** About 90% Accuracy for using pre-trained model 

****

### Assignment
****
[Assignment Link](https://www.freecodecamp.org/learn/machine-learning-with-python/machine-learning-with-python-projects/cat-and-dog-image-classifier)
